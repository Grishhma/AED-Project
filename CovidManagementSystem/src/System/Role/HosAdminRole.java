...
import UI.Hospital.HospAdminJPanel;
 ...
 * @author riddhivora
 */
public class HosAdminRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, Place city, UserAccount userAccount, Organization organization, 
        ...
        return new HospAdminJPanel(userProcessContainer,city, userAccount, organization, enterprise, system);
    } 
}
