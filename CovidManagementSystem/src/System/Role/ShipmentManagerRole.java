...
import UI.VaccineProducer.ShipmentManagerJPanel;
import UI.VaccineProducer.ManageDeliveryManagerJPanel;
import UI.VaccineProducer.ManageOrdersJPanel;
/**
 *
 * @author riddhivora
 */
public class ShipmentManagerRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, Place city, UserAccount userAccount, Organization organization, 
        ...
        return new ShipmentManagerJPanel(userProcessContainer,city, userAccount, organization, enterprise, system);
    } 
